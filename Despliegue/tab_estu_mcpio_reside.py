...
# -----------------------------
try:
    df = pd.read_csv("./government_icfes_dataset/data/datos_variables_seleccionadas.csv")
    df_mapa = pd.read_csv("./government_icfes_dataset/data/Municipios_col.csv", encoding="latin1")
...
if municipios_sin_coords:
    pd.DataFrame({'Municipio_Faltante': municipios_sin_coords}).to_csv(
        './government_icfes_dataset/data/municipios_a_buscar_coordenadas.csv', index=False, encoding='utf-8'
    )
