...
def predict_new_sample(sample_data, encoders_file):
    ...
    reg_model_path = "./government_icfes_dataset/best_models/regression/model_regression_20250522_180347.pt"
    clf_model_path = "./government_icfes_dataset/best_models/classification/model_classification_20250522_100219.pt"
...
def ejecutar_predicciones(n_clicks, input_values):
    ...
    try:
        ...
        encoders_path = "./government_icfes_dataset/encoders/all_encoders_20250525_164501.pkl" # Revisa este nombre de archivo
...
if __name__ == "__main__":
    ...
    encoders_path_for_test = "./government_icfes_dataset/encoders/all_encoders_20250525_164501.pkl" # Revisa este nombre
